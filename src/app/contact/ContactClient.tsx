  ...
  const faqs = [
    {
      ...
      answer: "Sí, CFL La Rioja está registrado como institución de beneficio público. Puedes solicitar el recibo fiscal para tus donativos.",
    },
    {
      question: "¿Cómo sé en qué se usa mi donativo?",
      answer: "Mantenemos total transparencia. Recibirás reportes periódicos sobre cómo se utilizan tus contribuciones en nuestros programas.",
    },
    {
      question: "¿Puedo visitar el centro?",
      answer: "Sí, con cita previa. Las visitas nos ayudan a conectar con nuestros donantes y a mostrar el impacto real de su apoyo.",
    },
    {
      question: "¿Hay oportunidades de voluntariado?",
      answer: "Consideramos voluntarios calificados en áreas específicas. Contacta para conocer las oportunidades disponibles.",
    },
  ];
          ...
          <ScrollReveal>
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl md:text-2xl text-white/80 leading-relaxed font-light">
                Hay muchas formas de ser parte de nuestra misión de educar y transformar vidas. Tu apoyo hace la diferencia.
              </p>
            </div>
          </ScrollReveal>
        </div>
          ...
          <ScrollReveal>
            <div className="text-center max-w-3xl mx-auto mb-16">
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-larioja-azul dark:text-white tracking-tight">
                <HighlightedTitle title="Formas de Apoyar" highlightColor="text-larioja-verde" />
              </h2>
            ...
            {formsOfSupport.map((form, idx) => (
              <ScrollReveal key={form.title} delay={idx * 100}>
                <div className="bg-white dark:bg-larioja-azul p-8 rounded-[2.5rem] shadow-xl shadow-blue-900/5 border border-gray-100 dark:border-white/5 h-full flex flex-col group hover:-translate-y-1 transition-all duration-300">
                  <div className={`w-14 h-14 ${form.bg} rounded-2xl flex items-center justify-center ${form.color} mb-6`}>
                    <form.icon size={28} />
                  </div>
                  ...
                  <ul className="space-y-4 mb-8 flex-1">
                    {form.features.map((feature, i) => (
                      <li key={i} className="flex items-start gap-3 text-sm text-gray-600 dark:text-white/70">
                        <CheckCircle2 size={18} className={`${form.color} shrink-0 mt-0.5`} />
                        {feature}
                      </li>
                    ))}
                  </ul>
                  <button className={`w-full py-4 px-6 rounded-2xl font-bold transition-all ${form.color} ${form.bg} hover:scale-105 active:scale-95`}>
                    Saber más
                  </button>
                </div>
              </ScrollReveal>
          ...
          <div className="grid lg:grid-cols-2 gap-20 max-w-6xl mx-auto">
            ...
            <ScrollReveal direction="left">
              <div>
                ...
                <p className="text-lg text-gray-500 dark:text-white/60 mb-12">
                  Estamos aquí para escucharte y trabajar juntos por un futuro mejor.
                </p>
                ...
                <div className="space-y-8">
                  <div className="flex items-start gap-6 group">
                    ...
                    <div>
                      <h4 className="font-bold text-gray-900 dark:text-white mb-1">Teléfonos</h4>
                      <p className="text-gray-600 dark:text-white/60">7858-0322</p>
                      <p className="text-gray-600 dark:text-white/60">2248-4198</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-6 group">
                    ...
                    <div>
                      <h4 className="font-bold text-gray-900 dark:text-white mb-1">Correo</h4>
                      <p className="text-gray-600 dark:text-white/60">info@cflrioja.org</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-6 group">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-white/60">Residencial Altamira, San Salvador</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-6 group">
                    ...
                    <div>
                      <h4 className="font-bold text-gray-900 dark:text-white mb-1">Síguenos</h4>
                      <p className="text-gray-600 dark:text-white/60">@larioja_sv</p>
                    </div>
                  </div>
                </div>
            ...
            <ScrollReveal direction="right">
              <div className="bg-white dark:bg-larioja-azul p-8 md:p-12 rounded-[3rem] shadow-2xl shadow-blue-900/10 border border-gray-100 dark:border-white/5 relative">
                ...
                <h3 className="text-2xl font-bold mb-2 text-larioja-azul dark:text-white">Formulario de Contacto</h3>
                <p className="text-gray-500 dark:text-white/60 mb-8">Envíanos un mensaje y te responderemos pronto.</p>

                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label className="text-sm font-bold text-gray-700 dark:text-white/80 ml-1">Nombre *</label>
                      <input 
                        name="name"
                        type="text" 
                        required 
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-bold text-gray-700 dark:text-white/80 ml-1">Correo *</label>
                      <input 
                        name="email"
                        type="email" 
                        required 
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label className="text-sm font-bold text-gray-700 dark:text-white/80 ml-1">Teléfono</label>
                      <input 
                        name="phone"
                        type="tel" 
                        disabled={loading}
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-bold text-gray-700 dark:text-white/80 ml-1">Asunto *</label>
                      <select 
                        name="type"
                        disabled={loading}
                      ...
                      >
                        ...
                        <option value="Donativos Monetarios">Donativos Monetarios</option>
                        <option value="Donativos en Especie">Donativos en Especie</option>
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-bold text-gray-700 dark:text-white/80 ml-1">Mensaje *</label>
                    <textarea 
                      name="message"
                      required 
                      disabled={loading}
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <ScrollReveal>
              <div className="text-center mb-16">
                <h2 className="text-4xl md:text-5xl font-bold mb-6 text-larioja-azul dark:text-white tracking-tight">
                  <HighlightedTitle title="Preguntas Frecuentes" highlightColor="text-larioja-verde" />
                </h2>
                <p className="text-lg text-gray-500 dark:text-white/60">
            ...
            <div className="bg-larioja-amarillo p-12 md:p-20 rounded-[3rem] relative overflow-hidden text-center max-w-5xl mx-auto shadow-2xl">
              ...
              <div className="relative z-10">
                ...
                <p className="text-xl text-larioja-azul/80 mb-12 max-w-2xl mx-auto font-medium">
                  Estamos aquí para ayudarte. No dudes en contactarnos con cualquier inquietud.
                </p>
