...
export default async function SelectCompanyPage() {
  ...
  if (error || !companies || companies.length === 0) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-larioja-gradient p-4 relative overflow-hidden">
        {/* Soften the background saturation */}
        <div className="absolute inset-0 bg-white/20 dark:bg-black/40 pointer-events-none" />
        <Card className="max-w-md p-8 text-center bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm rounded-3xl relative z-10">
          <Title className="text-larioja-azul dark:text-larioja-amarillo">
            Sin Acceso
          </Title>
          <Text className="mt-4">
            No tienes empresas asociadas a tu cuenta. Contacta al administrador.
          </Text>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-larioja-gradient p-4 transition-colors relative overflow-hidden">
      ...
      <div className="w-full max-w-2xl relative z-10">
        <Card className="p-8 bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm shadow-xl border-2 border-white/20 dark:border-gray-800 rounded-2xl">
              ...
              <form key={uc.company_id} action={selectCompany}>
                ...
                >
                  <div className="flex items-center gap-4">
                    <div className="p-3 bg-white dark:bg-gray-700 rounded-xl group-hover:scale-105 transition-transform shadow-sm">
                      <Building2
                  ...
                  <ChevronRight
                    className="text-gray-300 group-hover:text-larioja-azul dark:group-hover:text-larioja-amarillo transition-colors"
                    size={20}
                  />
                </button>
              </form>
