...
export default async function Home() {
  ...
  return (
    <main className="min-h-screen bg-white dark:bg-gray-950 transition-colors duration-300">
      {/* Logo (Top Left) */}
      <div className="fixed top-4 left-4 z-50 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm p-2 rounded-xl border border-white/20 dark:border-gray-800 shadow-sm transition-colors">
      ...
      <nav className="fixed top-4 right-4 z-50 flex items-center gap-2 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md p-2 rounded-2xl border border-white/20 dark:border-gray-800 shadow-lg transition-colors">
        <div className="flex items-center gap-2">
          <Link
            href="/about"
            className="bg-larioja-amarillo hover:bg-yellow-400 text-larioja-azul font-bold py-1.5 px-4 rounded-full text-xs transition-all shadow-sm"
          >
            Nosotros
          </Link>
          <Link
            href="/bingo"
            className="bg-larioja-verde hover:bg-green-700 text-white font-bold py-1.5 px-4 rounded-full text-xs transition-all shadow-sm"
          >
            Bingo
          </Link>
          <Link
            href="/admin"
            className="bg-larioja-azul hover:bg-blue-900 text-white font-bold py-1.5 px-4 rounded-full text-xs transition-all shadow-sm"
          >
            Panel de Control
          </Link>
          <ThemeToggle />
      ...
      {/* Hero Section */}
      <section
        className="relative h-[80vh] flex items-center justify-center text-white bg-larioja-azul dark:bg-larioja-azul/40 overflow-hidden 
        before:absolute before:inset-0 before:bg-larioja-azul/60 dark:before:bg-gray-900/80 before:z-10"
      >
