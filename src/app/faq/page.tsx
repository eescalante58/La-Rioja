...
export const metadata = {
  ...
  description: "Respuestas a las preguntas más comunes sobre nuestros programas, inscripción y servicios.",
};
      ...
      <section className="bg-larioja-azul text-white pt-32 pb-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-20 text-center max-w-4xl">
          ...
          <p className="text-lg md:text-xl font-light opacity-90 max-w-2xl mx-auto">
            Respuestas a las preguntas más comunes sobre nuestros programas, inscripción y servicios.
          </p>
        </div>
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-900 transition-colors">
        <div className="container mx-auto px-6 text-center max-w-3xl">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 mb-10">
            Si no encuentras la respuesta que buscas, no dudes en contactarnos. Nuestro equipo está disponible para ayudarte.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Button asChild className="bg-larioja-azul hover:bg-larioja-azul/90 text-white rounded-full px-8 py-6 h-auto text-lg shadow-xl shadow-larioja-azul/20">
              <Link href="/contact" className="flex items-center gap-2">
                <MessageSquare size={20} />
                Enviar Consulta
              </Link>
            </Button>
            <Button asChild variant="outline" className="border-larioja-azul text-larioja-azul hover:bg-larioja-azul/5 rounded-full px-8 py-6 h-auto text-lg">
        ...
        <div className="container mx-auto px-6 text-center">
          <div className="bg-larioja-verde/5 dark:bg-larioja-verde/10 p-12 rounded-3xl border border-larioja-verde/20 max-w-4xl mx-auto">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-8 max-w-xl mx-auto">
              Visita nuestros programas y conoce cómo podemos apoyar a tu familia.
            </p>
            <Button asChild className="bg-larioja-verde hover:bg-larioja-verde/90 text-white rounded-full px-8">
      ...
      <footer className="bg-larioja-azul text-white py-12">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="opacity-50 text-sm">
            &copy; <DynamicYear /> Centro de Formación Laboral La Rioja. Todos los derechos reservados.
          </p>
        </div>
      </footer>
    </main>
