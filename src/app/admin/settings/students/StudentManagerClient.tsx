            ...
            <div className="space-y-1">
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  // These hidden inputs will be used by the action
          ...
          {assignMode === "single" ? (
            <form onSubmit={handleAssignSubmit} className="space-y-4">
              ...
              <div className="flex justify-end gap-3 mt-8">
                ...
                <Button type="submit" loading={assignFormLoading} color="amber">
                  Asignar Cartón
                </Button>
              </div>
            </form>
                  ...
                  {studentCards.map((card, idx) => (
                    <TableRow key={idx}>
                      ...
                      <TableCell>
                        <Badge
                          color={
                            card.card_status === "Vendido" ? "emerald" : "blue"
                          }
                          size="xs"
                        >
                          {card.card_status}
                      ...
                      <TableCell className="text-right">
                        <Button
                          ...
                          onClick={() => handleQuickUnassign(card.card_number)}
                        />
                      </TableCell>
                    </TableRow>
                  ))}
      ...
      >
        <DialogPanel className="max-w-lg">
          <div className="flex items-center justify-between mb-6">
            ...
            {selectedInvoice && (
              <Badge color="blue" size="sm" icon={Hash} className="text-white">
          ...
          {selectedInvoice ? (
              ...
              <Card className="p-4 bg-gray-50 dark:bg-gray-800 border-none">
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    <UserCircle className="text-larioja-azul mt-1" size={20} />
            ...
            <Text className="italic text-gray-500 py-6 text-center">
